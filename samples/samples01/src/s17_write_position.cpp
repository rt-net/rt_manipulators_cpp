...
int main()
{
  ...
  std::cout<<"right_handグループのサーボ最大加速度を0.5pi rad/s^2、最大速度を0.5pi rad/sに設定します."<<std::endl;
  ...
  std::cout<<"torsoグループのサーボ最大加速度を0.5pi rad/s^2、最大速度を0.5pi rad/sに設定します."<<std::endl;
  ...
  std::cout<<"right_hand、torsoグループのサーボ位置制御PIDゲインに(800, 0, 0)を書き込みます."<<std::endl;
  ...
  std::cout<<"5秒後にSciurus17が正面を向く姿勢へ移行するため、Sciurus17の周りに物や人を近づけないで下さい."<<std::endl;
  ...
  std::cout<<"ID:"<<std::to_string(dxl_id)<<"のサーボ目標角度に"<<std::to_string(target_position)<<" radを書き込みます."<<std::endl;
  ...
  std::cout<<joint_name<<"ジョイントのサーボ目標角度に"<<std::to_string(target_position)<<" radを書き込みます."<<std::endl;
  ...
  std::cout<<"right_hand、torsoグループのサーボ位置制御PIDゲインに(5, 0, 0)を書き込み、脱力させます."<<std::endl;
